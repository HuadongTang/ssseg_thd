...
class ISNet(BaseSegmentor):
    ...
    def forward(self, x, targets=None):
        ...
        feats_sl, context_prior_map = self.slc_net(feats, preds, feats_il)
        ...
        if self.mode == 'TRAIN':
            ...
            outputs_dict.update({'loss_cls_stage1': preds_stage1, 'loss_cls_stage2': preds_stage2, 'loss_aff': context_prior_map})
