...
SEGMENTOR_CFG['work_dir'] = 'upernet_swinbase_pascalcontextkl_newpre_lossreduce_fpcninput_memloss'
SEGMENTOR_CFG['logfilepath'] = 'upernet_swinbase_pascalcontextkl_newpre_lossreduce_fpcninput_memloss/upernet_swinbase_pascalcontext.log'
SEGMENTOR_CFG['resultsavepath'] = 'upernet_swinbase_pascalcontextkl_newpre_lossreduce_fpcninput_memloss/upernet_swinbase_pascalcontext_results.pkl'
