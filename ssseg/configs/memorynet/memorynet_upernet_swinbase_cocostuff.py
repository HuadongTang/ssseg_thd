...
SEGMENTOR_CFG['work_dir'] = 'upernet_swinbase_cocostuffk_newpre_lossreduce_fpcninput'
SEGMENTOR_CFG['logfilepath'] = 'upernet_swinbase_cocostuffk_newpre_lossreduce_fpcninput/upernet_swinbase_cocostuffk.log'
SEGMENTOR_CFG['resultsavepath'] = 'upernet_swinbase_cocostuffk_newpre_lossreduce_fpcninput/upernet_swinbase_cocostuffk_results.pkl'
