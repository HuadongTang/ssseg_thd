...
def parsecmdargs():
    ...
    parser.add_argument('--cfgfilepath', dest='cfgfilepath', help='config file path you want to use', default='/home/minzhou/Data/edcode/sssegmentation/ssseg/configs/memorynet/memorynet_deeplabv3_resnet101os8_ade20k.py',type=str)
    parser.add_argument('--ckptspath', dest='ckptspath', help='checkpoints you want to resume from', default=False, type=str)
